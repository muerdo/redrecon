...
func RunAmass(ctx context.Context, target, tempDir, proxy string, logger *slog.Logger) (string, error) {
	t := config.Cfg.Tools.Amass // FIX: Aponta para a configuração centralizada em 'Tools'.
